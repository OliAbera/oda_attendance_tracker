...
class AddTeacher1Page extends StatefulWidget {
  @override
  _AddTeacher1PageState createState() => _AddTeacher1PageState();
}

class _AddTeacher1PageState extends State<AddTeacher1Page> {
